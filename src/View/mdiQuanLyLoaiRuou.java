...
public class mdiQuanLyLoaiRuou extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "QUẢN LÝ LOẠI SẢN PHẨM", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 0, 14))); // NOI18N

        jLabel41.setText("Mã loại sản phẩm");
        ...
        jPanel1.getAccessibleContext().setAccessibleName("QUẢN LÝ LOẠI SẢN PHẨM"); // NOI18N
    ...
    private void cmdxoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdxoaActionPerformed
        ...
        int kq=JOptionPane.showConfirmDialog(this,"Bạn có muốn xóa mã sản phẩm ["+macu+"] này không?","Thông báo",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if(kq==JOptionPane.YES_OPTION)
    ...
    private void cmdghiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdghiActionPerformed
       //ktra rong
        if(txtmaloairuou.getText().length() <= 0)
        {
            JOptionPane.showMessageDialog(this, "Bạn chưa có mã loại sản phẩm","Thông báo",JOptionPane.WARNING_MESSAGE);
            txtmaloairuou.requestFocus();
            return;
        }
        if(txttenloairuou.getText().length() <= 0)
        {
            JOptionPane.showMessageDialog(this, "Bạn chưa đặt tên loại sản phẩm!","Thông báo",JOptionPane.WARNING_MESSAGE);
        ...
        {
            JOptionPane.showMessageDialog(this, "Bạn nhập trùng mã loại sản phẩm","Thông báo",JOptionPane.ERROR_MESSAGE);
            txtmaloairuou.requestFocus();
            return;
        }
        //ghi
