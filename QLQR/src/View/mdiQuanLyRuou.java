...
//        }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Quản lý rượu");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "QUẢN LÝ RƯỢU", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 0, 14))); // NOI18N
        ...
        dgDanhSach.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã rượu", "Tên rượu", "Giá bán", "Mã loại rượu", "Mã NSX", "Tình trạng", "Số lượng"
            }
        ) {
    ...
    private void cmdghiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdghiActionPerformed
        //ktra rong
        if (txtmaruou.getText().length() <= 0) {
            JOptionPane.showMessageDialog(this, "Bạn chưa có mã rượu", "Thông báo", JOptionPane.WARNING_MESSAGE);
            txtmaruou.requestFocus();
            return;
        }
        if (txttenruou.getText().length() <= 0) {
            JOptionPane.showMessageDialog(this, "Bạn chưa đặt tên rượu!", "Thông báo", JOptionPane.WARNING_MESSAGE);
        ...
        if (QuanLyRuou_Controller.KiemTraTrungMa(txtmaruou.getText(), ktThem, macu) == true) {
            JOptionPane.showMessageDialog(this, "Bạn trùng mã rượu", "Thông báo", JOptionPane.ERROR_MESSAGE);
            txtmaruou.requestFocus();
            return;
        }
        //ghi
