...
//        txtthanhtien.setEditable(!b);
    ...
    private void initComponents() {
        ...
        dgDanhSach.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã hóa đơn", "Mã nhân viên", "Ngày lập", "Tên khách", "Điện thoại", "Email", "Địa chỉ", "Thành tiền", "Mã rượu", "Giá bán", "Số lượng"
            }
        ));
    ...
    private void cmdghiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdghiActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(this, "Mã rượu này hiện đã hết hàng!", "Thông báo", JOptionPane.ERROR_MESSAGE);
            return;
        }
